...
//[["CONNECTOR_v4.c","STARTRESET.c","RED_v4.c","BLUE_v4.c", "parent_v8.c", "YELLOW_v4.c", "INFO_v1.c", "HARD_RESET.c"]]
...
vector GREEN_DARK =  <0.0, 0.6, 0.0>;
vector GREEN_BRIGHT = <0.0, 1.0, 0.0>;
...
{ 
    state_entry()
    {
        llSetColor(GREEN_DARK, ALL_SIDES);
...
state GREEN_BUTTON
{
    state_entry()
    {
        llSetColor(GREEN_BRIGHT, ALL_SIDES);
