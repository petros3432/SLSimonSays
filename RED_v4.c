...
//[["CONNECTOR_v4.c","STARTRESET.c","BLUE_v4.c","GREEN_v4.c", "parent_v8.c", "YELLOW_v4.c", "INFO_v1.c", "HARD_RESET.c"]]
...
vector RED_DARK =  <0.6, 0.2, 0.0>;
vector RED_BRIGHT = <1.0, 0.0, 0.0>;
...
state RED_BUTTON
{
    state_entry()
    {
        llSetColor(RED_BRIGHT, ALL_SIDES);
