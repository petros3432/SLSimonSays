...
//[["CONNECTOR_v4.c","STARTRESET.c","RED_v4.c","GREEN_v4.c", "parent_v8.c", "YELLOW_v4.c", "INFO_v1.c", "HARD_RESET.c"]]
...
vector BLUE_DARK =  <0.0, 0.0, 1.0>;
vector BLUE_BRIGHT = <0.0, 0.8, 1.0>;
...
{ 
    state_entry()
    {
        llSetColor(BLUE_DARK, ALL_SIDES);
...
state BLUE_BUTTON
{
    state_entry()
    {
        llSetColor(BLUE_BRIGHT, ALL_SIDES);
